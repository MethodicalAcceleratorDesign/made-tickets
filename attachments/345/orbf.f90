...
6004 format(16(2X,F7.2))
    ...
    print*," dmmpy 1 utmat array has size ic=",ic," im=",im
    
    call dmmpyPiotr(im,im,utmat(1,1),utmat(1,2),utmat(2,1),                &
        &xin(1),xin(2),xa(1),xa(2),ic,im)
...
subroutine dmmpy(m,n,x,x12,x21,y,y2,z,z2)
    ...
    lzi   =  1
    !xsize = 
    !print*,"array x has size ",shape(x)
    ...
    do     i  =  1, m
        ...
        do  j  =  1, n
            ...
            !print*, "dmmpy i=",i," j=",j," lxij=",lxij," lyj=",lyj
            !print*, "dmmpy x(",lxij,")=",x(lxij)
            !print*, "dmmpy y(lyj)=",y(lyj)
...
subroutine dmmpyPiotr(m,n,x,x12,x21,y,y2,z,z2,xmax1,xmax2)
    implicit none
    integer m,n,ix,jx,jy,iz,lxi1,lzi,i,lxij,lyj,j,locf
    integer xmax1, xmax2
    double precision x(*),x12(*),x21(*),y(*),y2(*),z(*),z2(*),sum,zero
    ...
    do     i  =  1, m
        ...
        do  j  =  1, n
            ...
            if (lxij > xsize) then
              ...
              print*,"Array x index ",lxij," out of bounds ",xsize
              stop;
            endif
            tmp1 = x(lxij)
            tmp2 = y(lyj)
